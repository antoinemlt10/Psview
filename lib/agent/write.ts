...
const SYSTEM = [
  ...
  "PROSE NATIVE & GRAMMATICALE : écris comme un locuteur natif de la langue de sortie.",
  "Aucun calque d'une autre langue : articles obligatoires (« la plupart des… » et non",
  "« plupart des… »), accords, ordre des mots corrects. Relis-toi avant de rendre.",
  "",
  ...
  const parts = [
    ...
    args.stage === "intro"
      ? [
          ...
          "  - INTERDIT : démarrer par une description d'entreprise (« X est une plateforme… »,",
          "    « X is a YC-backed platform that… », « Nous sommes une startup… »). Accroche d'abord,",
          "    contexte entreprise ensuite (1 ligne max), amené naturellement.",
